...
export default function PlanUsageCard(props) {
    return (
        <div class="shadow-lg rounded-xl w-36 p-4 bg-white dark:bg-gray-800">
            ...
            <div class="flex flex-col justify-start">
                <p class="text-gray-800 text-xl text-left dark:text-white font-bold my-4">
                    2500/5000
                </p>
                <div class="relative w-28 h-2 bg-gray-200 rounded">
                    <div className={`absolute top-0 h-2  left-0 rounded  w-2/3 ${props.color}`}>
                    </div>
                </div>
            </div>
        </div>
